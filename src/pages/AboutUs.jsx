...
import i18n from '../components/Trans/i18.js'
   ...
   console.log(i18n)
    ...
    return(
        <Section header={t("About Us")}>
            <Typography  fontSize={{xs:'20px',md:'24px'}} lineHeight={{xs:'30px', md:'50px'}} textAlign={i18n.language === 'en'? 'left':'right'} p={{xs:'0 20px', md:'0 100px'}}>
